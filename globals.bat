...
set CreatePortableZip32=7z a -tzip -mx=9 %PortableFileZip32% %AppExe32% README.txt palettes\* lang\*.* pictures\sample.png
set CreatePortable7z32=7z a -t7z -mx=9 %PortableFile7z32% %AppExe32% README.txt palettes\* lang\*.* pictures\sample.png
...
set CreatePortableZip64=7z a -tzip -mx=9 %PortableFileZip64% %AppExe64% README.txt palettes\* lang\*.* pictures\sample.png
set CreatePortable7z64=7z a -t7z -mx=9 %PortableFile7z64% %AppExe64% README.txt palettes\* lang\*.* pictures\sample.png
